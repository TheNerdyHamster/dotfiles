...
myLayout = avoidStruts (tiled ||| Mirror tiled ||| Full)
  where
     ...
     tiled   = spacingRaw False (Border 0 0 0 0) True (Border 10 10 10 10) True $ Tall nmaster delta ratio
...
--
main = do 
  xmproc <- spawnPipe "xmobar -x 0 /home/lilahamstern/.config/xmobar/xmobarrc"
